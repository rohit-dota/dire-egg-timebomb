function ExecuteMoveOrders(unit)
	for _,d in pairs(unit.destinations) do
		...
		local yPos = d["1"]
		local zPos = d["2"]
		print("[MoveOrders] " .. unit.timerName .. " is moving to (" .. xPos .. "," .. yPos .. "," .. zPos .. ")")
...
function RegisterMoveOrder(cursor_position)
	...
	print("[MoveOrders] " .. activeUnit.timerName .. "'s move order to " .. "(" .. cursor_position["0"] .. "," .. cursor_position["1"] .. "," .. cursor_position["2"] .. ") registered")
end